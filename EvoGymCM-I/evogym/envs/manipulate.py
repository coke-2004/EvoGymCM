...
class CarrySmallRectToTable(PackageBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 1, 4, connections=connections, material_scales=material_scales)
...
class PushSmallRectOnOppositeSide(PackageBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 13, 1, connections=connections, material_scales=material_scales)
...
class CatchSmallRect(PackageBase):
    ...
    def __init__(
        ...
        self.robot_material_scales = material_scales
    ...
    def random_init(self):
        ...
        self.world.add_from_array('robot', self.robot_body, 22, 1, connections=self.robot_connections, material_scales=self.robot_material_scales)
...
class LiftSmallRect(PackageBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 2, 3, connections=connections, material_scales=material_scales)
