...
class StepsUp(StairsBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 1, 1, connections=connections, material_scales=material_scales)
...
class StepsDown(StairsBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 1, 11, connections=connections, material_scales=material_scales)
...
class WalkingBumpy(StairsBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 2, 1, connections=connections, material_scales=material_scales)
...
class WalkingBumpy2(StairsBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 2, 4, connections=connections, material_scales=material_scales)
...
class FloatingPlatform(StairsBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 1, 6, connections=connections, material_scales=material_scales)
...
class BlockSoup(StairsBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 1, 9, connections=connections, material_scales=material_scales)
