...
class Balance(BenchmarkBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 15, 3, connections=connections, material_scales=material_scales)
...
class BalanceJump(BenchmarkBase):
    ...
    def __init__(
        ...
        self.world.add_from_array('robot', body, 10, 1, connections=connections, material_scales=material_scales)
