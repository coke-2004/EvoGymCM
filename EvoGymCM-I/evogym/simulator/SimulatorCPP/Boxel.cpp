...
{
	point_top_right_index = -1;
	point_top_left_index = -1;
	point_bot_right_index = -1;
	point_bot_left_index = -1;
	material_scale = 1.0;
...
void Boxel::set_material_scale(double scale) {
	material_scale = scale;
}

double Boxel::get_material_scale() const {
